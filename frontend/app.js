...
document.addEventListener('DOMContentLoaded', () => {
    ...
    evalBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            const evalPromise = fetch(evalUrl, { method: 'POST', body: fd });
            ...
            console.group('📥 [LLM] Evaluate Response');
            ...
            if (!resp.ok) {
                ...
                try { const e = await resp.json(); console.error('Error body:', e); errMsg = e.error || errMsg; } catch(_) {}
                console.groupEnd();
            ...
            console.log('Result: OK |', (blob.size / 1024).toFixed(1), 'KB');
            console.groupEnd();
